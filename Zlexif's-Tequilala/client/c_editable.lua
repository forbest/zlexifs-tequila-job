...
RegisterNetEvent('zlexif:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 6000, false, true, {
        ...
        TriggerServerEvent("zlexif:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('zlexif:client:Drink', function(itemName)
...
RegisterNetEvent('zlexif:client:DrinkAlcahol', function(itemName)
